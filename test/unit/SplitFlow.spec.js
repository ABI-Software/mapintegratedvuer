...
const testState = {
  entries: [
    {
      availableSpecies: {
        Cat: { displayWarning: true, iconClass: 'icon-mapicon_cat', taxo: 'NCBITaxon:9685' },
      ...
      state: {
        ...
        state: {
          ...
          viewport: {
            center: [-1.588289745831446, -4.569422936609342],
            layers: [],
            zoom: 5.306304273218617,
          },
        },
      },
      type: 'MultiFlatmap',
    ...
    },
    {
      ...
      mode: 'normal',
      resource:
        'https://mapcore-bucket1.s3-us-west-2.amazonaws.com/Generic+Scaffold/Heart/rat/ratHeart_metadata.json',
      state: {
        url: 'https://mapcore-bucket1.s3-us-west-2.amazonaws.com/Generic+Scaffold/Heart/rat/ratHeart_metadata.json',
        viewport: {
          eyePosition: [-28.577901783471873, 10.67032586821228, 19.394740246822778],
          farPlane: 95.21289155481732,
          nearPlane: 1.9384671731808958,
          targetPosition: [0.0422978401184082, -1.384324312210083, -3.813697338104248],
    ...
    },
    {
      ...
      mode: 'maximised',
      resource:
        'https://mapcore-bucket1.s3-us-west-2.amazonaws.com/Generic+Scaffold/Stomach/rat/ratStomach_metadata.json',
      state: {
        url: 'https://mapcore-bucket1.s3-us-west-2.amazonaws.com/Generic+Scaffold/Stomach/rat/ratStomach_metadata.json',
        viewport: {
          eyePosition: [-13.488481259165301, -66.35447897586697, 18.370723175779926],
          farPlane: 172.86934980256643,
          nearPlane: 3.5194977735601167,
          targetPosition: [0.2898273468017578, 0.17322444915771484, -0.040380001068115234],
...
const data = [
  {
    ...
    label: 'Colon',
    resource:
      'https://mapcore-bucket1.s3-us-west-2.amazonaws.com/Generic+Scaffold/Colon/human/humanColon_metadata.json',
    type: 'Scaffold',
  },
  {
  ...
  },
  {
    ...
    datasetImage:
      'https://assets.discover.blackfynn.com/dataset-assets/29/6/revisions/1/banner.jpg',
  },
];
