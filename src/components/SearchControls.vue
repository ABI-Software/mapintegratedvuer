<template>
  <div class="search-container">
    <div class="text search-text">Search within display</div>
    <el-autocomplete
      class="search-box"
      placeholder="Search"
      v-model="searchText"
    ...
    ></el-autocomplete>
    <map-svg-icon icon="magnifyingGlass" class="magnify" @click="$emit('search', searchText)" />
    <div v-if="failedSearch" class="text not-found-text">'{{ failedSearch }}' not found</div>
  </div>
</template>
