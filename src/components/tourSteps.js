...
var keyButton = '<button class="control-button" id="nerve-key-button" type="button" title="Show/hide paths" aria-label="Show/hide paths" style="display: inline;">KEY</button>'
export default [
    {
