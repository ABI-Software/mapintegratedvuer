...
export default {
  ...
  methods: {
    ...
    goFullscreen: function () {
      ...
      } else if (mapApp.mozRequestFullScreen) {
        /* Firefox */
  ...
  beforeMount: function () {
    if (this.options) {
      ...
      this.options.algoliaIndex
        ? this.settingsStore.updateAlgoliaIndex(this.options.algoliaIndex)
        : null;
      ...
      this.options.pennsieveApi
        ? this.settingsStore.updatePennsieveApi(this.options.pennsieveApi)
        : null;
